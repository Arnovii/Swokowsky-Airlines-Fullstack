...
const HeroBanner: React.FC = () => {
  const backgroundImage = heroBanner;
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 sm:px-6 md:px-0">
        ...
        <div className="text-center sm:text-left w-full max-w-2xl sm:max-w-4xl mb-8 sm:mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold leading-tight drop-shadow-lg font-title">
            Tu próxima aventura comienza ahora.
          </h1>
          <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-semibold drop-shadow-lg mt-3 mb-6 font-oswald">
            Vuelos desde 2 millones
          </h2>
          <Button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-full shadow-lg transition duration-300 ease-in-out">
            Reserva Ahora
          </Button>
        </div>
