              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <DatePicker
                            ...
                            className="w-full px-4 py-3 pl-11 bg-white border-2 border-blue-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-200 outline-none font-semibold text-gray-900"
                  ...
                  <div className="bg-gradient-to-br from-[#0a1836] via-[#123361] to-[#081225] rounded-2xl p-6 border-2 border-[#123361]">
                    ...
                    {errores.llegada && <p className="text-rose-500 text-sm mt-2 font-semibold">{errores.llegada}</p>}
                  </div>
                </div>
              </div>
